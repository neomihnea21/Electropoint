"""
Django settings for route2 project.
...
SECRET_KEY = 'django-insecure-uu@p-p=q(9r!1lrny!(@g6fh@e(+6qj0c$ynim08%*0hs@-b&)'
...
WSGI_APPLICATION = 'route2.wsgi.application'
